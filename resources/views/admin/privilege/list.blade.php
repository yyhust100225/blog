                    ...
                    <div class="card">
                        <div class="header data-table-header">
                            ...
                            <ul class="header-dropdown dropdown">
                                ...
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" privilege="button" aria-haspopup="true" aria-expanded="false"></a>
...
@section('js')
    ...
    <script type="text/javascript">
        var table = $('.data-table').DataTable({
            ...
            "columns": [
                {data:"id", orderable:true, width:'5%', searchable:true},
                {data:"name", orderable:true, width:'15%', searchable:true},
                {data:"pc_id", orderable:true, width:'15%', searchable:true},
                {data:"controller", orderable:true, width:'15%', searchable:true},
                {data:"route", orderable:true, width:'20%', searchable:true},
                {data:"remark", orderable:true, width:'25%', searchable:true},
        ...
        bindInsertFormData("{{ route('privilege.create') }}");
        bindEditFormData("{{ route('privilege.edit') }}");
        bindDeleteFormData("{{ route('privilege.delete') }}", table);
    </script>
@endsection
